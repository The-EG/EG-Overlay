...
void overlay_3d_create_sprite_list_pso() {
    size_t vertlen = 0;
    char *vertbytes = load_file("shaders/sprite-list.vert.cso", &vertlen);

    size_t pixellen = 0;
    char *pixelbytes = load_file("shaders/sprite-list.pixel.cso", &pixellen);
...
void overlay_3d_create_trail_pso() {
    size_t vertlen = 0;
    char *vertbytes = load_file("shaders/trail.vert.cso", &vertlen);

    size_t pixellen = 0;
    char *pixelbytes = load_file("shaders/trail.pixel.cso", &pixellen);
