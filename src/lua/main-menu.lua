...
mm_settings:setdefault('window.x', 10)
mm_settings:setdefault('window.y', 10)
mm_settings:setdefault('window.width', 150)
mm_settings:setdefault('window.height', 100)
...
overlay.addeventhandler('register-module-actions', main_menu.add_item)
